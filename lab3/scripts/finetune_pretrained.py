...
if __name__ == '__main__':
    ...
    for model in PRETRAINED_MODELS:
      ...
      if DATASET == 'MR' and model == PRETRAINED_MODELS[1]:
        tokenizer = AutoTokenizer.from_pretrained('distilbert-base-uncased', model_max_length=40)
      else:
        tokenizer = AutoTokenizer.from_pretrained(model, model_max_length=40)
